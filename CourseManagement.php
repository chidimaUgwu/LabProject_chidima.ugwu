<?php
// C:\xampp\htdocs\Attandance\FI_CourseManagement.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_course'])) {
    ...
    header("Location: FI_CourseManagement.php");
    exit();
}
...
<body>
    ...
    <div class="board">
        <nav>
            <a href="FI_Dashboard.php" data-section="dashboard"><i class="fas fa-home"></i> <span>Dashboard</span></a>
            <a href="FI_CourseManagement.php" class="active" data-section="courses"><i class="fas fa-book"></i> <span>Course Management</span></a>
            <a href="FI_sessions.php" data-section="sessions"><i class="fas fa-calendar-alt"></i> <span>Session Overview</span></a>
            <a href="FI_attendance.php" data-section="attendance"><i class="fas fa-clipboard-check"></i> <span>Attendance Reports</span></a>
            <a href="FI_performance.php" data-section="performance"><i class="fas fa-chart-line"></i> <span>Student Performance</span></a>
            <a href="FI_profile.php" data-section="profile"><i class="fas fa-user"></i> <span>Profile</span></a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="action-buttons">
                                ...
                                <a href="FI_course_details.php?id=<?php echo $course['id']; ?>" class="action-btn view" title="View Details">
    ...
    <div class="modal" id="addCourseModal">
        <div class="modal-content">
            ...
            <form id="courseForm" method="POST" action="FI_CourseManagement.php">
...
function confirmDelete(courseId, courseCode) {
    if (confirm(`Are you sure you want to delete course "${courseCode}"?\n\nThis will also delete all associated sessions, enrollments, and attendance records!`)) {
        window.location.href = `FI_CourseManagement.php?delete=${courseId}`;
    }
}
...
function editCourse(courseId) {
    ...
    // You can implement this by redirecting to an edit page:
    // window.location.href = `FI_edit_course.php?id=${courseId}`;
}
</script>
</body>
</html>